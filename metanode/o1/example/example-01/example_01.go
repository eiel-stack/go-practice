...
func main() {
	//client, err := ethclient.Dial("https://eth-sepolia.g.alchemy.com/v2/WT9Z7fE0OHBaXNOT08O2T")
	client, err := ethclient.Dial("https://sepolia.infura.io/v3/5f1bfd0a704249ee8b7a9f528f309fdf")
	if err != nil {
		log.Fatal(err)
	}
